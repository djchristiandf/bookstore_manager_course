...
import static com.djchristiandf.bookstoremanager.utils.BookUtils.asJsonString;
import static com.djchristiandf.bookstoremanager.utils.BookUtils.createFakeBookDTO;
...
public class BookControllerTest {
    ...
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(bookController)
                ...
                .setViewResolvers((viewNme, locale) -> new MappingJackson2JsonView())
                .build();
    }

    @Test
    void testWhenPOSTcreateBook() throws Exception {
    ...
    @Test
    void testWhenPOSTcreateInvalidISBNBook() throws Exception {
        BookDTO bookDTO = createFakeBookDTO();
        bookDTO.setIsbn("Invalid value");
